            ...
            <table class="table table-hover align-middle modern-table shadow-sm rounded-3 overflow-hidden">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= htmlspecialchars($row['vehicle_make'] . ' ' . $row['vehicle_model'] . ' (' . $row['vehicle_year'] . ')') ?></td>
                  <td><?= htmlspecialchars($row['service_list'] ?: '—') ?></td>
                  <td><?= date("h:i A", strtotime($row['reservation_time'])) ?> - <?= date("h:i A", strtotime($row['end_time'])) ?></td>
                  <td>
                    <?php
