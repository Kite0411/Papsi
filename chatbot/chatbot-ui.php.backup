...
const API_URL = 'http://127.0.0.1:5000/chat'; // must match your Flask address
...
async function sendChatbotMessage() {
    ...
    try {
        ...
        if (err.name === 'AbortError') {
            ...
            addMessage('Sorry, I\'m having trouble connecting to the chatbot server. Make sure Flask is running at http://127.0.0.1:5000', false);
