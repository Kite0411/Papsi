<?php
// Admin Chatbot UI Component - Fixed for Render Production
// IMPORTANT: Replace YOUR_RENDER_URL with your actual Render deployment URL
?>
<style>
...
<script>
// 🔥 PRODUCTION CONFIGURATION - Replace with your actual Render URL
const RENDER_URL = 'https://your-app-name.onrender.com'; // ⚠️ CHANGE THIS!

// Use the unified bot endpoints (already in your app.py)
